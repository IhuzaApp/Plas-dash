...
export const INGREDIENT_CATALOGUE: IngredientCatalogueItem[] = [
  ...
  { id: 'cat-001', name: 'Flour', unit: 'kg', unitCost: 2.0 },
  { id: 'cat-002', name: 'Sugar', unit: 'kg', unitCost: 1.5 },
  { id: 'cat-003', name: 'Yeast', unit: 'kg', unitCost: 5.0 },
  { id: 'cat-004', name: 'Cheese', unit: 'kg', unitCost: 8.0 },
  // Additional common ingredients
  { id: 'cat-005', name: 'Butter', unit: 'kg', unitCost: 6.0 },
  { id: 'cat-006', name: 'Eggs', unit: 'piece', unitCost: 0.25 },
  { id: 'cat-007', name: 'Fresh Milk', unit: 'liter', unitCost: 0.8 },
  { id: 'cat-008', name: 'Cocoa Powder', unit: 'kg', unitCost: 7.5 },
  { id: 'cat-009', name: 'Baking Powder', unit: 'kg', unitCost: 4.0 },
  { id: 'cat-010', name: 'Salt', unit: 'kg', unitCost: 0.3 },
  { id: 'cat-011', name: 'Olive Oil', unit: 'liter', unitCost: 5.0 },
  { id: 'cat-012', name: 'Tomatoes', unit: 'kg', unitCost: 1.2 },
  { id: 'cat-013', name: 'Onions', unit: 'kg', unitCost: 0.6 },
  { id: 'cat-014', name: 'Garlic', unit: 'kg', unitCost: 3.0 },
  { id: 'cat-015', name: 'Heavy Cream', unit: 'liter', unitCost: 3.5 },
  { id: 'cat-016', name: 'Vanilla Extract', unit: 'liter', unitCost: 40.0 },
  { id: 'cat-017', name: 'Mozzarella', unit: 'kg', unitCost: 10.0 },
  { id: 'cat-018', name: 'Pizza Dough Base', unit: 'kg', unitCost: 1.8 },
];
...
export const DUMMY_PRODUCTION_ORDERS: ProductionOrder[] = [
  {
    id: 'po-001',
    recipeId: 'rec-001',
    recipeName: 'Classic White Bread Loaf',
    batchQty: 5,
    status: 'Completed',
    assignedStaff: 'Alice Uwimana',
    scheduledDate: '2026-02-20T06:00:00Z',
    completedDate: '2026-02-20T10:00:00Z',
    totalIngredientCost: 45.5,
    notes: 'Morning batch for weekend rush.',
    createdAt: '2026-02-18T14:00:00Z',
  },
  {
    id: 'po-002',
    recipeId: 'rec-002',
    recipeName: 'Chocolate Fudge Cake',
    batchQty: 3,
    status: 'Completed',
    assignedStaff: 'Jean-Pierre Habimana',
    scheduledDate: '2026-02-21T08:00:00Z',
    completedDate: '2026-02-21T14:00:00Z',
    totalIngredientCost: 68.0,
    createdAt: '2026-02-19T09:00:00Z',
  },
  {
    id: 'po-003',
    recipeId: 'rec-003',
    recipeName: 'Butter Croissant',
    batchQty: 2,
    status: 'In Progress',
    assignedStaff: 'Marie Mukamana',
    scheduledDate: '2026-02-28T05:00:00Z',
    totalIngredientCost: 140.0,
    notes: 'Double-check lamination layers.',
  ...
  },
  {
    ...
    batchQty: 10,
    status: 'In Progress',
    assignedStaff: 'Eric Nshimiyimana',
    scheduledDate: '2026-02-28T09:00:00Z',
    totalIngredientCost: 35.0,
    createdAt: '2026-02-27T11:00:00Z',
  },
  {
    id: 'po-005',
    recipeId: 'rec-006',
    recipeName: 'Classic Tomato Sauce',
    batchQty: 4,
    status: 'Draft',
    assignedStaff: 'Alice Uwimana',
    scheduledDate: '2026-03-01T06:00:00Z',
    totalIngredientCost: 72.0,
  ...
  },
  {
    ...
    status: 'Draft',
    assignedStaff: 'Jean-Pierre Habimana',
    scheduledDate: '2026-03-02T06:00:00Z',
    totalIngredientCost: 72.0,
  ...
  },
  {
    ...
    totalIngredientCost: 45.0,
    notes: 'Cancelled due to cocoa shortage.',
...
export const RECIPE_PRODUCTION_VOLUME = DUMMY_RECIPES.map(r => ({
  ...
  fullName: r.name,
  batches: DUMMY_PRODUCTION_ORDERS.filter(o => o.recipeId === r.id && o.status === 'Completed')
    .length,
