...
export const menuPrivileges: Record<string, MenuPrivilege> = {
  ...
  'Company Dashboard': { module: 'company_dashboard', isProjectUser: true },
  'Shop Dashboard': { module: 'shop_dashboard', isProjectUser: true },
  Checkout: { module: 'checkout', isProjectUser: true },
  Inventory: { module: 'inventory', isProjectUser: true },
  Transactions: { module: 'transactions', isProjectUser: true },
  Discounts: { module: 'discounts', isProjectUser: true },
  'Financial Overview': { module: 'financial_overview', isProjectUser: true },
  'Staff Management': { module: 'staff_management', isProjectUser: true },
