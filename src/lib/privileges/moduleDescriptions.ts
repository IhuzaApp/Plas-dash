...
export const MODULE_DESCRIPTIONS: Record<PrivilegeKey, ModuleDescription> = {
  ...
  company_dashboard: {
    ...
    actions: [
      ...
      { key: 'view_performance_metrics', label: 'View Performance Metrics', description: 'Can view performance data' },
    ]
  },
  shop_dashboard: {
    ...
    actions: [
      ...
      { key: 'manage_daily_targets', label: 'Manage Daily Targets', description: 'Can set and manage daily targets' },
      { key: 'view_shop_performance', label: 'View Shop Performance', description: 'Can view shop performance metrics' },
      { key: 'view_staff_performance', label: 'View Staff Performance', description: 'Can view staff performance data' },
      { key: 'view_customer_metrics', label: 'View Customer Metrics', description: 'Can view customer-related metrics' },
    ]
  },
  financial_overview: {
    ...
    actions: [
      { key: 'access', label: 'Access Financial Overview', description: 'Can access financial overview page' },
      { key: 'view_profits', label: 'View Profits', description: 'Can view profit information' },
      { key: 'export_financial_data', label: 'Export Financial Data', description: 'Can export financial data' },
  ...
  pos_terminal: {
    ...
    actions: [
      ...
      { key: 'apply_promotions', label: 'Apply Promotions', description: 'Can apply promotional offers' },
    ]
  },
  products: {
    title: 'Products',
  ...
  orders: {
    ...
    actions: [
      ...
      { key: 'view_order_history', label: 'View Order History', description: 'Can view order history' },
    ]
  },
  users: {
    title: 'Users',
  ...
  shoppers: {
    ...
    actions: [
      ...
      { key: 'manage_shopper_data', label: 'Manage Shopper Data', description: 'Can manage shopper data' },
      { key: 'view_shopper_history', label: 'View Shopper History', description: 'Can view shopper history' },
    ]
  },
  wallet: {
    title: 'Wallet',
  ...
  refunds: {
    ...
    actions: [
      ...
      { key: 'view_refund_history', label: 'View Refund History', description: 'Can view refund history' },
    ]
  },
  tickets: {
    title: 'Tickets',
  ...
  help: {
    ...
    actions: [
      ...
      { key: 'view_help_articles', label: 'View Help Articles', description: 'Can view help articles' },
      { key: 'create_help_articles', label: 'Create Help Articles', description: 'Can create new help articles' },
      { key: 'edit_help_articles', label: 'Edit Help Articles', description: 'Can edit help articles' },
      { key: 'delete_help_articles', label: 'Delete Help Articles', description: 'Can delete help articles' },
      { key: 'manage_help_categories', label: 'Manage Help Categories', description: 'Can manage help categories' },
    ]
  },
  settings: {
    title: 'Settings',
  ...
  promotions: {
    ...
    actions: [
      ...
      { key: 'manage_promotion_rules', label: 'Manage Promotion Rules', description: 'Can manage promotion rules' },
      { key: 'export_promotions', label: 'Export Promotions', description: 'Can export promotion data' },
    ]
  },
  delivery_settings: {
    ...
    actions: [
      { key: 'access', label: 'Access Delivery Settings', description: 'Can access delivery settings page' },
      { key: 'view_delivery_settings', label: 'View Delivery Settings', description: 'Can view delivery settings' },
      { key: 'edit_delivery_settings', label: 'Edit Delivery Settings', description: 'Can edit delivery settings' },
      { key: 'manage_delivery_zones', label: 'Manage Delivery Zones', description: 'Can manage delivery zones' },
      { key: 'manage_delivery_fees', label: 'Manage Delivery Fees', description: 'Can manage delivery fees' },
      { key: 'view_delivery_reports', label: 'View Delivery Reports', description: 'Can view delivery reports' },
    ]
  },
};
