                ...
                <TableRow key={plan.id}>
                  ...
                  <TableCell>
                    <div className="text-sm space-y-1">
                      <div>
                        <span className="text-muted-foreground">AI:</span> {plan.ai_request_limit}
                      </div>
                      <div>
                        <span className="text-muted-foreground">Reels:</span> {plan.reel_limit}
                      </div>
                    </div>
                  </TableCell>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          toast({
                            ...
                            description: 'Plan deletion UI to be implemented.',
                          });
                        }}
                      >
