      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-50">
            Tax Dashboard & Forecasting
          </h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">
            Monitor your tax liabilities and forecast future payments.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <Button
            variant="outline"
            className="gap-2 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 border-slate-200 dark:border-slate-700 transition-colors"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden relative group">
          ...
          <CardContent className="z-10">
            ...
            <div className="flex items-center mt-2 text-sm text-red-600 dark:text-red-400 font-medium">
        ...
        <Card className="rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden relative group">
          ...
          <CardContent className="z-10">
            ...
            <div className="flex items-center mt-2 text-sm text-orange-600 dark:text-orange-400 font-medium">
              12 days remaining
            </div>
          </CardContent>
        </Card>
            ...
            <CardHeader className="flex flex-row items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-4">
              <div>
                ...
                <CardDescription className="dark:text-slate-400">
                  Projected monthly tax based on revenue & expenses
                </CardDescription>
              </div>
              ...
              <div className="h-[350px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    />
                    <Tooltip
                      cursor={{ fill: 'rgba(51,65,85,0.08)' }}
                      contentStyle={{
                        borderRadius: '12px',
                        border: 'none',
            ...
            <CardContent className="pt-0 px-0">
              <ul className="divide-y divide-slate-100 dark:divide-slate-800">
                {taxCategories.map((category, idx) => (
                  <li
                    key={idx}
                    className="p-4 sm:px-6 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
                  >
              ...
              <div className="p-4 border-t border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50">
                <Button className="w-full bg-slate-900 dark:bg-slate-700 hover:bg-slate-800 text-white rounded-xl shadow-sm">
          ...
          <Card className="rounded-2xl overflow-hidden bg-gradient-to-br from-blue-600 to-blue-800 text-white relative border-none shadow-sm">
            ...
            <CardContent>
              <p className="text-blue-100 text-sm leading-relaxed mb-4">
                ...
                that haven&apos;t been claimed for the current quarter. Claiming these could reduce
                your estimated tax by <strong className="text-white">~18%</strong>.
              </p>
