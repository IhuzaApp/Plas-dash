            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm font-medium">
                  {referral.name || referral.User?.name || 'N/A'}
                </p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground">Email Address</p>
                <p className="text-sm font-medium">
                  {referral.email || referral.User?.email || 'N/A'}
                </p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground">Phone Number</p>
                <p className="text-sm font-medium">
                  {referral.phone || referral.User?.phone || 'N/A'}
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <Badge
                  variant="outline"
                  className={referral.User?.is_active ? 'text-green-600' : 'text-red-600'}
                >
                          ...
                          return (
                            <tr key={order.id}>
                              ...
                              <td className="px-4 py-2 text-right">
                                RWF {selling.toLocaleString()}
                              </td>
                              <td className="px-4 py-2 text-right text-green-600 font-medium">
                                RWF{' '}
                                {earning.toLocaleString(undefined, {
