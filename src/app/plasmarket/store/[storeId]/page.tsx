...
import { Store, Package, ShoppingBag, MapPin, Clock, ArrowLeft, Loader2 } from 'lucide-react';
        ...
        <AdminLayout>
          <div className="p-6">
            ...
            <Alert variant="destructive">
              ...
              <AlertDescription>
                {(error as Error)?.message || 'Failed to load store profile.'}
              </AlertDescription>
            </Alert>
          </div>
        </AdminLayout>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Button
                variant="outline"
                size="icon"
                onClick={() => router.push(`/plasmarket/${data.business_id}`)}
              >
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-4 border-t">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    {data.description || 'No description available for this store.'}
                  </p>
                </div>
              </CardContent>
            </Card>
                ...
                <CardHeader className="pb-0">
                  <TabsList>
                    ...
                    <TabsTrigger value="orders">
                      Orders & Analytics ({data.orders_count})
                    </TabsTrigger>
                  </TabsList>
                </CardHeader>
                          ...
                          >
                            ...
                            <CardContent className="p-4 flex-1 flex flex-col justify-between">
                              <div>
                                ...
                                <h4 className="font-bold line-clamp-1" title={product.name}>
                                  {product.name}
                                </h4>
                                ...
                                <TableRow key={order.id}>
                                  ...
                                  <TableCell>
                                    ...
                                    <div className="text-xs text-muted-foreground">
                                      {order.orderedBy?.email || order.orderedBy?.phone || ''}
                                    </div>
                                  </TableCell>
