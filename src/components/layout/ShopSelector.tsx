            ...
            <Tooltip>
              ...
              <TooltipContent side="right">
                <div className="text-xs">
                  ...
                  <p className="opacity-70">Click to logout from shop</p>
                </div>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
      ...
      <div className="space-y-2">
        <TooltipProvider delayDuration={0}>
          <Tooltip>
              ...
              >
                ...
                >
                  {isSidebarOpen ? (
                    ...
                    <Store className="h-5 w-5 text-sidebar-foreground/40" />
                  )}
                </CardContent>
              </Card>
            </TooltipTrigger>
            {!isSidebarOpen && (
              <TooltipContent side="right">
                <p className="text-xs font-medium">{orgEmployee.Shops.name}</p>
              </TooltipContent>
            )}
          </Tooltip>
        </TooltipProvider>
