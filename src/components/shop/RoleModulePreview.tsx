        ...
        <div className="space-y-1.5">
          {accessible.map(group => {
            ...
            return (
              <div
                key={group.module}
                className="rounded-md border border-green-200 dark:border-green-800 bg-green-50/60 dark:bg-green-900/20 overflow-hidden"
              >
                <button
                  type="button"
                ...
                >
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <Badge
                      variant="secondary"
                      className="text-[0.65rem] px-1.5 py-0 h-4 bg-green-200/70 text-green-800 dark:bg-green-800 dark:text-green-200 shrink-0"
                    >
