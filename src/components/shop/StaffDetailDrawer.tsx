          ...
          <div className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {staff.Position || staff.position || 'Staff'}
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 gap-1">
              ...
              <DetailItem
                icon={Activity}
                label="Employee ID"
                value={staff.employeeID || staff.id.slice(0, 8)}
              />
              <DetailItem
                icon={Store}
                label="Assigned Store"
                value={staff.Shops?.name || staff.store || 'Central Store'}
              />
              <DetailItem
                icon={Shield}
                label="Role Type"
                value={<Badge variant="outline">{staff.roleType || 'N/A'}</Badge>}
              />
