...
const InfluencerProfile = ({ id }: InfluencerProfileProps) => {
    ...
    const { data: influencer, isLoading } = useQuery({
        ...
        queryFn: () =>
            apiGet<{ influencer: any }>(`/api/queries/influencers?id=${id}`).then(r => r.influencer),
    });
    ...
    const totalEarnings =
        influencer.influencer_earnings?.reduce(
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3 mt-1">
                                ...
                                <span
                                    className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium ${influencer.status === 'active'
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="flex justify-between items-center text-sm">
                                    ...
                                    <span className="font-medium capitalize">
                                        {influencer.payment_terms || 'Standard'}
                                    </span>
                                </div>
                                <div className="flex justify-between items-center text-sm">
                                    <span className="text-muted-foreground">Contract Period</span>
                                    <span className="font-medium">
                                        {influencer.contract_start_date
                                            ? format(new Date(influencer.contract_start_date), 'MMM yyyy')
                                            : ''}
                                        {influencer.contract_end_date
                                            ? ` - ${format(new Date(influencer.contract_end_date), 'MMM yyyy')}`
                                            : 'Open'}
                                    </span>
                                </div>
                            </CardContent>
                            ...
                            <CardContent className="space-y-6">
                                <div className="space-y-1">
                                    ...
                                    <p className="font-medium capitalize">
                                        {influencer.payment_method?.replace('_', ' ') || 'N/A'}
                                    </p>
                                </div>
                                    ...
                                    {influencer.promotions?.length === 0 ? (
                                        ...
                                        influencer.promotions?.map((promo: any) => (
                                            <TableRow key={promo.id}>
                                                ...
                                                <TableCell>
                                                    {currency} {promo.earning_per_order || 0}
                                                </TableCell>
                                                <TableCell>
                                                    <span
                                                        className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] uppercase font-bold ${promo.status === 'active'
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between">
                            <div>
                                ...
                                <CardDescription>
                                    Rules defining how earnings are calculated based on performance.
                                </CardDescription>
                            </div>
                                        ...
                                        influencer.influencer_commissions?.map((rule: any) => (
                                            <TableRow key={rule.id}>
                                                ...
                                                <TableCell>
                                                    ...
                                                    {rule.high_value_influencer_bonus &&
                                                        rule.high_value_influencer_bonus !== '0' && (
                                                ...
                                                <TableCell>
                                                    ...
                                                    {rule.high_value_order_threshold &&
                                                        rule.high_value_order_threshold !== '0' && (
                                        ...
                                        influencer.influencer_earnings?.map((earning: any) => (
                                            <TableRow key={earning.id}>
                                                ...
                                                <TableCell className="font-bold text-green-600">
                                                    {currency} {earning.earning_amount}
                                                </TableCell>
                                                <TableCell>
                                                    <span
                                                        className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium ${earning.status === 'paid'
                                                ...
                                                <TableCell className="text-xs font-mono text-muted-foreground">
                                                    {earning.shop_order_id ||
                                                        earning.restaurant_order_id ||
                                                        earning.reel_order_id ||
                                                        'N/A'}
                                                </TableCell>
                                            </TableRow>
                                        ))
                                        ...
                                        <FormItem>
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="percentage_of_order">
