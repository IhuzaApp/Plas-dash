        ...
        <Card className="border-none shadow-none bg-transparent">
          ...
          <CardContent className="px-0 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <VerificationItem
              icon={ImageIcon}
              label="Plate Number"
              value={shopper.plate_number}
              isImage={true}
            />
            <VerificationItem
              icon={FileText}
              label="Driving License"
              value={shopper.driving_license}
            />
      ...
      <Card className="border-none shadow-none bg-transparent">
        ...
        <CardContent className="px-0 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <VerificationItem
            ...
            value={shopper.national_id_photo_front}
            isImage
          />
          <VerificationItem
            icon={ImageIcon}
            label="National ID (Back)"
            value={shopper.national_id_photo_back}
            isImage
          />
          <VerificationItem
            icon={ImageIcon}
            label="Driving License (Front)"
            value={shopper.driving_license_front}
            isImage
          />
          <VerificationItem
            icon={ImageIcon}
            label="Driving License (Back)"
            value={shopper.driving_license_back}
            isImage
          />
          <VerificationItem
            icon={ImageIcon}
            label="Police Clearance"
            value={shopper.Police_Clearance_Cert}
            isImage
          />
          <VerificationItem
            icon={ImageIcon}
            label="Proof of Residency"
            value={shopper.proofOfResidency}
            isImage
          />
          <VerificationItem
            icon={ImageIcon}
            label="Mutual Status Cert"
            value={shopper.mutual_StatusCertificate}
            isImage
          />
          <VerificationItem
            icon={ImageIcon}
            label="Driving License Cert"
            value={shopper.drivingLicense_Image}
            isImage
          />
        </CardContent>
      </Card>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {Array.isArray(shopper.face_liveness_images) ? (
                ...
                <div className="relative group aspect-square rounded-xl overflow-hidden border">
                  <img
                    src={shopper.face_liveness_images}
                    alt="Liveness"
                    className="w-full h-full object-cover"
                  />
                </div>
          ...
          <CardContent className="px-0 space-y-4">
            <div className="p-4 border rounded-xl bg-zinc-50/50 dark:bg-zinc-900/50">
              ...
              {shopper.SignaturePad ? (
                <img
                  src={shopper.SignaturePad}
                  alt="Signature Pad"
                  className="max-h-20 object-contain invert dark:invert-0"
                />
              ) : (
