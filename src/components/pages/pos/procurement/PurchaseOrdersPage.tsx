...
export default function PurchaseOrdersPage() {
  ...
  const filteredOrders = DUMMY_PURCHASE_ORDERS.filter(
    order =>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                ...
                <h3 className="text-2xl font-bold mt-1 truncate">{DUMMY_PURCHASE_ORDERS.length}</h3>
              </div>
                ...
                <h3 className="text-2xl font-bold mt-1 truncate">
                  {
                    DUMMY_PURCHASE_ORDERS.filter(
                      po => po.deliveryStatus === 'Pending' || po.deliveryStatus === 'Partial'
                    ).length
                  }
                </h3>
              </div>
                ...
                {filteredOrders.length === 0 ? (
                  ...
                  filteredOrders.map(order => (
                    <TableRow key={order.id}>
                      <TableCell className="font-medium text-primary">{order.poNumber}</TableCell>
                      <TableCell>
