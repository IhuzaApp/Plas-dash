...
export default function QuotationsPage() {
  ...
  const filteredQuotations = DUMMY_QUOTATIONS.filter(
    quote =>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                ...
                <h3 className="text-2xl font-bold mt-1 truncate">{DUMMY_QUOTATIONS.length}</h3>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                ...
                <h3 className="text-2xl font-bold mt-1 truncate">
                  {
                    DUMMY_QUOTATIONS.filter(q => q.status === 'Sent' || q.status === 'Received')
                      .length
                  }
                </h3>
              </div>
