    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          {
            label: 'Gross Profit',
            value: fmt(Math.max(0, grossProfit)),
            icon: DollarSign,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <Card className="lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              {recipe.yieldQty * batches} {recipe.yieldUnit} · Waste: {recipe.wastePct}% ·
              Cost/Unit: <strong>{fmt(finalCPU)}</strong>
            </CardDescription>
          </CardHeader>
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow className="bg-orange-50/50 dark:bg-orange-950/10">
                  <TableCell colSpan={3} className="text-sm text-orange-700 dark:text-orange-300">
                    Waste ({recipe.wastePct}%)
                  </TableCell>
                ...
                <TableRow className="border-t-2 bg-muted/20">
                  <TableCell colSpan={3} className="font-semibold text-sm">
                    Ingredient Subtotal (incl. waste)
                  </TableCell>
          ...
          <CardContent>
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="flex justify-between text-xs text-muted-foreground">
                ...
                <span
                  className={
                    margin >= 30 ? 'text-green-600 font-medium' : 'text-amber-600 font-medium'
                  }
                >
                  {margin >= 40
                    ? '🟢 Excellent'
