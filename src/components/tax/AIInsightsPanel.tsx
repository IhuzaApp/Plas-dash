...
const INSIGHTS: Insight[] = [
  {
    ...
    body: [
      'You spent 18% more on marketing than the industry average.',
      'Potential optimization: Adjust allocation timing to shift spend into the next fiscal year.',
    ],
    severity: 'warning',
  ...
  },
  {
    ...
    body: [
      'Equipment purchases totaling $9,750 were detected in your imported data.',
      'You may qualify for Section 179 accelerated depreciation.',
    ],
  ...
  },
  {
    ...
    body: [
      'Revenue increased 22% over last quarter based on imported transaction history.',
      'At current trajectory, your annual taxable income will rise significantly.',
    ],
    severity: 'info',
...
export function AIInsightsPanel() {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div
        className={`fixed top-0 right-0 h-full w-[360px] z-40
      ...
      >
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 mt-0.5">
                {INSIGHTS.length} insights from imported data
              </p>
            </div>
          </div>
          <button
              ...
              >
                ...
                <div className="pl-4 pr-4 py-4 space-y-3 bg-white dark:bg-slate-900">
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <Badge className={`text-[10px] font-bold shrink-0 border-none ${cfg.badgeCls}`}>
                      {cfg.label}
                    </Badge>
                  </div>
                  {/* Body */}
                  ...
                  >
                    <DollarSign
                      className={`h-4 w-4 shrink-0 ${insight.impactPositive ? 'text-green-600 dark:text-green-400' : 'text-red-500 dark:text-red-400'}`}
                    />
                    <div>
                      ...
                      <p
                        className={`text-base font-black font-mono ${insight.impactPositive ? 'text-green-700 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}
                      >
                        {insight.impactValue}
                      </p>
                    </div>
                  ...
                  >
                    {isApplied ? (
                      <>
                        <CheckCircle2 className="h-3.5 w-3.5" /> Simulation Applied
                      </>
                    ) : (
                      <>
                        <ArrowRight className="h-3.5 w-3.5" /> Apply Simulation
                      </>
                    )}
                  </Button>
                </div>
        ...
        <div className="border-t border-slate-100 dark:border-slate-800 px-5 py-4 shrink-0 bg-slate-50/50 dark:bg-slate-900">
          <p className="text-[10px] text-slate-400 dark:text-slate-500 leading-relaxed">
            Insights auto-generated from imported transaction data and industry benchmarks.
            Simulations do not affect your filed tax return.
          </p>
        </div>
      </div>
    </>
