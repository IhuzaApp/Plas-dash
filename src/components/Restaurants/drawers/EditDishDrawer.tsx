...
const EditDishDrawer: React.FC<EditDishDrawerProps> = ({ dish, isOpen, onClose, onSuccess }) => {
    ...
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent className="sm:max-w-[540px] flex flex-col p-0">
        <SheetHeader className="p-6 pb-2">
          ...
          <SheetDescription>Update restaurant-specific details and dish image.</SheetDescription>
        </SheetHeader>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    onValueChange={value => {
                      ...
                      if (selectedPromo) {
                        ...
                        if (
                          selectedPromo.promotion_type === 'percentage' &&
                  ...
                  >
                    <SelectTrigger className="bg-background">
                      <SelectValue
                        placeholder={
                          isLoadingPromos ? 'Loading promotions...' : 'Choose a promotion...'
                        }
                      />
                    </SelectTrigger>
                    <SelectContent>
        ...
        <SheetFooter className="p-6 border-t bg-background">
          <Button
            variant="outline"
            onClick={onClose}
            disabled={updateRestaurantDish.isPending || isUploading}
          >
            Cancel
          </Button>
          <Button
            ...
            disabled={updateRestaurantDish.isPending || isUploading}
          >
            {updateRestaurantDish.isPending && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
            Save Changes
          </Button>
        </SheetFooter>
      </SheetContent>
