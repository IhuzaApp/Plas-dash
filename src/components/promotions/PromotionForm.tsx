                    ...
                    <form id="promo-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-muted/30 p-4 rounded-xl space-y-4 border">
                                ...
                                <div className={cn("grid gap-4 pt-4 border-t", watchAll.business_type === 'none' ? "grid-cols-1" : "grid-cols-2")}>
                                    <FormField
                                        control={form.control}
                                        name="status"
                                        render={({ field }) => (
            ...
            <div className="border-t bg-background p-4 sm:p-6 space-y-4 mt-auto">
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-3 text-sm flex flex-col gap-2">
                    <div className="flex items-center justify-between">
                        ...
                        {watchAll.business_type === 'none' && <span className="bg-purple-100 text-purple-800 px-2 py-0.5 rounded text-xs font-medium">Influencer</span>}
                    </div>
                    <div>
                        ...
                        <span className="text-muted-foreground mt-1 block">
                            ...
                            {['rush_hour', 'flash_sale', 'bundle'].includes(watchPromotionType as string) && watchAll.discount_value ? `${watchAll.discount_value} ` : ''}
