                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3 bg-background rounded-lg p-4 border shadow-sm text-xs">
                        ...
                        <div className="flex justify-between">
                            ...
                            <span>{systemConfig?.currency || 'Ksh'} {promotion.min_purchase_amount || '0'}</span>
                        </div>
                        <div className="flex justify-between">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3 bg-background rounded-lg p-4 border shadow-sm text-xs">
                        <div className="flex justify-between">
                            ...
                            <span className="font-medium text-primary">{promotion.Influencer?.name || (promotion.influencer_id === 'none' ? 'Generic' : 'Not assigned')}</span>
                        </div>
                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between pt-2 border-t">
                            ...
                            <span className="font-bold text-green-600">{systemConfig?.currency || 'Ksh'} {promotion.earning_per_order || '0'}</span>
                        </div>
                    </div>
                </div>
            </div>
