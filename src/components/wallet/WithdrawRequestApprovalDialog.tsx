                ...
                {step === 'review' && (
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>Review the details before approving or rejecting.</DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="space-y-4 py-2">
                            ...
                            <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                                <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                                    {isBusiness ? <Building2 className="h-5 w-5 text-primary" /> : <User className="h-5 w-5 text-primary" />}
                                </div>
                                ...
                                <Badge variant="secondary" className="capitalize shrink-0">{typeLabel}</Badge>
                            </div>
                                ...
                                {isBusiness && withdrawChargesPct > 0 && (
                                    <>
                                        <div className="flex justify-between items-center text-sm">
                                            <span className="text-muted-foreground">Withdraw Charge ({withdrawChargesPct}%)</span>
                            ...
                            {isPayout && (item as PayoutData).Wallets?.Wallet_Transactions?.length ? (
                                <div className="rounded-lg border p-3 space-y-2">
                                    <p className="text-xs font-medium uppercase text-muted-foreground tracking-wider">Recent Transactions</p>
                        ...
                        <DialogFooter className="gap-2 sm:gap-0">
                            <Button variant="outline" className="text-red-500 hover:bg-red-50 border-red-200" onClick={handleReject} disabled={rejectLoading}>
                                {rejectLoading ? <Loader2 className="h-4 w-4 animate-spin mr-1" /> : <XCircle className="h-4 w-4 mr-1" />}
                                Reject
                            </Button>
                    ...
                    <>
                        ...
                        <div className="py-4">
                            <div className="rounded-lg bg-amber-50 border border-amber-200 p-4 text-sm text-amber-900 space-y-2">
                                ...
                                <p>Enable Two-Factor Authentication in your account settings, then return to approve this request.</p>
                            </div>
                        </div>
                        <DialogFooter>
                ...
                {step === 'otp' && (
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>Check the notification for your one-time code and enter it below.</DialogDescription>
                        </DialogHeader>
                        <div className="py-4 space-y-4">
                            <div className="rounded-lg bg-blue-50 border border-blue-200 p-3 text-sm text-blue-800">
                                <strong>Note:</strong> OTP shown in the toast (development mode). In production this would arrive via SMS.
                            </div>
                ...
                {step === 'confirm' && (
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>Final confirmation before the transfer is processed.</DialogDescription>
                        </DialogHeader>
                        <div className="py-4 space-y-4">
                            <div className="rounded-lg border p-4 space-y-3 bg-muted/30">
                                ...
                                <div className="flex justify-between font-semibold">
                                    <span>Net Payout</span>
                                    <span className="text-green-600">{formatAmt(isBusiness ? netPayout : amount, currency)}</span>
                                </div>
                            </div>
                        ...
                        <DialogFooter className="gap-2 sm:gap-0">
                            ...
                            <Button className="bg-green-600 hover:bg-green-700" onClick={handleConfirmApprove} disabled={loading}>
