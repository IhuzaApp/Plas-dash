            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {user.shopper && (
                    <Badge className="bg-blue-100 text-blue-800">Shopper</Badge>
                  )}
                </div>
              </div>
            </div>
                ...
                <div className="space-y-3">
                  ...
                  {user.Addresses?.length > 0 && (
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="font-medium">
                        {user.Addresses.find(addr => addr.is_default)?.street || user.Addresses[0].street}
                      </span>
                    </div>
                  )}
                </div>
                ...
                <Card className="p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <Badge className={user.shopper.active ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}>
                ...
                <Card className="p-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="font-medium">{formatDateTime(user.Wallets[0].last_updated)}</span>
                    </div>
                  </div>
                </Card>
              )}
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <Card className="p-4">
                        ...
                        <div className="text-2xl font-bold mt-1">
                          {(() => {
                            const totalHours = user.Shopper_Availabilities?.reduce((acc, curr) => {
                              if (!curr.is_available || !curr.start_time || !curr.end_time) return acc;
                              try {
                            ...
                            const availableDays = user.Shopper_Availabilities?.filter(s => s.is_available).length || 1;
